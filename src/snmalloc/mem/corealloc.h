...
namespace snmalloc
{
  ...
  class CoreAllocator : public cpp::conditional_t<
  ...
  public:
    ...
    template<
      ...
      typename = cpp::enable_if_t<Config_::Options.CoreAllocOwnsLocalState>>
    ...
    cpp::enable_if_t<!InlineQueue> init_message_queue(RemoteAllocator* q)
    {
      remote_alloc = q;
      init_message_queue();
      message_queue().invariant();
  ...
  public:
    static capptr::Alloc<CA> make()
    {
      ...
      auto p = capptr::Alloc<CA>::unsafe_from(new (raw.unsafe_ptr(), inplace_token) CA(r));
