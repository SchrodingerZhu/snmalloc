...
namespace snmalloc
{
  ...
  public:
    ...
    {
      static_assert(
        cpp::is_base_of<FrontendSlabMetadata_Trait, BackendType>::value,
      ...
      new (&client_meta_, inplace_token)
    ...
    void initialise_large(address_t slab, const FreeListKey& key)
    {
      ...
      new (&client_meta_, inplace_token) typename ClientMeta::StorageType();
    }
    ...
    static SNMALLOC_FAST_PATH cpp::pair<freelist::HeadPtr, bool>
    alloc_free_list(
      ...
      smallsizeclass_t sizeclass)
    {
      ...
      cpp::remove_reference_t<decltype(fast_free_list)> tmp_fl;
  ...
  class FrontendMetaEntry : public MetaEntryBase
  {
     ...
     */
    static_assert(
      cpp::is_convertible_v<SlabMetadataType, FrontendSlabMetadata_Trait>,
