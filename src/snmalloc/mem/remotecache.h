...
namespace snmalloc
{
  ...
  class RemoteDeallocCacheBatching
  {
    ...
    cpp::array<freelist::Builder<false, true>, RINGS> open_builder;
    cpp::array<address_t, RINGS> open_meta = {0};
  ...
  template<typename Config>
  using RemoteDeallocCacheBatchingImpl = cpp::conditional_t<
  ...
  {
    cpp::array<freelist::Builder<false>, REMOTE_SLOTS> list;
